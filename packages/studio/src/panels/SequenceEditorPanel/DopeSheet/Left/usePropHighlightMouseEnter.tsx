import type {SequenceEditorTree_AllRowTypes} from '@encorejs/studio/panels/SequenceEditorPanel/layout/tree'
import type {PropAddress} from '@encorejs/core/types/public'
