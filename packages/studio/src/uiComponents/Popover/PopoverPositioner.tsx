...
import useBoundingClientRect from '@encorejs/studio/uiComponents/useBoundingClientRect'
...
import onPointerOutside from '@encorejs/studio/uiComponents/onPointerOutside'
