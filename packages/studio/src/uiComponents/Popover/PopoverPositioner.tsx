...
import useBoundingClientRect from '@encore/studio/uiComponents/useBoundingClientRect'
...
import onPointerOutside from '@encore/studio/uiComponents/onPointerOutside'
